...
Config.SingleUserShopMenu = true                      -- true = only one player can browse a shop menu at a time
Config.MenuLockMaxDistance = 20.0                     -- auto-release lock if player moves farther than this from showroom spots
Config.PlateFormat = 'AAA9999'                        -- plate pattern: A = uppercase letter, 9 = number
Config.Shops = {
    ['pdm'] = {
